  ...
  <div class="box-cont-negro">
    ...
    <div class="box-cont-blanco" id="box">
      ...
      if (empty($rsp)) {
        ...
        $tabla  = '<table id="nombre" data-nombre="correos" style="border-radius:10px; text-align:center;" class="table  rounded table-bordered table-striped table-hover salidas-tabla dt_active">';
        $tabla .= '<thead>';
